...
export class ServiceTierAddImages1735749226160 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "room_tier" ADD "images" text array NOT NULL`);
        await queryRunner.query(`ALTER TABLE "service_tier" ADD "images" text array NOT NULL`);
    }
